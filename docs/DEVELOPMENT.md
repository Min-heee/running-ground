# RunningGround — 개발 가이드

> 원래 저장소 루트에 있던 README입니다. 프로젝트 초기(2026년 4월)에 쓴 로컬 개발 메모라 일부 내용은 지금 구조와 다를 수 있습니다. 프로젝트 소개는 [루트 README](../README.md)를 보세요.
...
- iOS post-Expo Go workflow is documented in [docs/ios-dev-build-and-testflight.md](ios-dev-build-and-testflight.md).
- Release build setup is documented in [docs/release-build-guide.md](release-build-guide.md).
