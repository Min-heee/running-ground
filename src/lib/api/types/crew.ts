...
// 시즌 = KST 달력 한 달, 순위 = 인당 km(총거리 ÷ 시즌 멤버, 오너 2026-09-19), 1위 크루가 별 ★을 받는다.
...
export type CrewSeasonInfo = {
  ...
  priorKm: number;            // 직전 시즌 인당 평균 — 2026-09-19부터 점수에 안 쓰임(옛 앱 설명 카드 호환)
...
export type CrewStandingRow = {
  ...
  score: number;              // 인당 km = totalKm ÷ seasonMemberCount
